...
/* harmony import */ var _dropzone_directive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dropzone.directive */ "./src/app/dropzone.directive.ts");
...
module.exports = "<div class=\"file-list\">\r\n    <div *ngFor=\"let file of files | async\" class=\"details-container\">\r\n        <a [href]=\"file.downloadURL\" target=\"_blank\" rel=\"noopener\">{{file.path}}</a>\r\n    </div>\r\n</div>"

/***/ }),

/***/ "./src/app/file-list/file-list.component.scss":
/*!****************************************************!*\
  !*** ./src/app/file-list/file-list.component.scss ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2ZpbGUtbGlzdC9maWxlLWxpc3QuY29tcG9uZW50LnNjc3MifQ== */"
...
var FileListComponent = /** @class */ (function () {
    function FileListComponent(afs) {
        this.afs = afs;
        this.fileCollection = afs.collection('files');
    ...
    FileListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./file-list.component.html */ "./src/app/file-list/file-list.component.html"),
            styles: [__webpack_require__(/*! ./file-list.component.scss */ "./src/app/file-list/file-list.component.scss")]
        }),
...
/***/ "./src/app/upload-task/upload-task.component.scss":
/*!********************************************************!*\
  !*** ./src/app/upload-task/upload-task.component.scss ***!
  \********************************************************/
/*! no static exports found */
...
var UploadTaskComponent = /** @class */ (function () {
    ...
    UploadTaskComponent.prototype.startUpload = function () {
        var _this = this;
        // The storage path
        var path = Date.now() + "_" + this.file.name;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.db.collection('files').add({ downloadURL: this.downloadURL, path: path });
                        return [2 /*return*/];
                }
            });
        }); }));
    ...
    UploadTaskComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./upload-task.component.scss */ "./src/app/upload-task/upload-task.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_storage__WEBPACK_IMPORTED_MODULE_2__["AngularFireStorage"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]])
    ], UploadTaskComponent);
...
module.exports = "<div class=\"dropzone\" appDropzone (hovered)=\"toggleHover($event)\" (dropped)=\"onDrop($event)\"\n  [class.hovering]=\"isHovering\">\n\n  <h3>APK Drop Zone</h3>\n  <p>Drag and Drop a File</p>\n  <div class=\"file\">\n    <label class=\"file-label\">\n    <input class=\"file-input\" type=\"file\" (change)=\"onDrop($event.target.files)\">\n      <span class=\"file-cta\">\n        <span class=\"file-icon\">\n          <i class=\"fa fa-upload\"></i>\n        </span>\n        <span class=\"file-label\">\n          or choose a file…\n        </span>\n      </span>\n    </label>\n  </div>\n</div>\n\n<h3>Uploads</h3>\n\n<div class=\"details-container\" *ngFor=\"let file of files\">\n  <app-upload-task [file]=\"file\"></app-upload-task>\n</div>"
...
var UploaderComponent = /** @class */ (function () {
    ...
    UploaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./uploader.component.scss */ "./src/app/uploader/uploader.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], UploaderComponent);
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyBK6j49ABRfIucvnMcMum2sXM47pmVcXT0",
        authDomain: "fileupload-6c683.firebaseapp.com",
        databaseURL: "https://fileupload-6c683.firebaseio.com",
        projectId: "fileupload-6c683",
        storageBucket: "fileupload-6c683.appspot.com",
        messagingSenderId: "77965735011"
    }
};
/*
...
module.exports = __webpack_require__(/*! D:\angular\workspace\fileupload\src\main.ts */"./src/main.ts");
